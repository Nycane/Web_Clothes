                        ...
                        return (
                            <div key={i} className={cx('product-item')}>
                                <div className={cx('product-info')}>
                                    <Image alt={e.name} src={e.image} width="50px" height="50px"></Image>

                                    <div className={cx('product-content')}>
                                        <div className={cx('product-name-variant')}>
                                            <p
                                            ...
                                            <p className={cx('product-color')}>{e.color && e.size && ` - ${e.color} - ${e.size}`}</p>
                                        </div>
                                ...
                                >
                                    {formatPrice.format(
                                        (e.price_discount > 0 ? e.price_discount : e.price) * e.quantity,
                                    )}
                                </h5>
                            </div>
                        );
